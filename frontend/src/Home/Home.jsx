...
const Home = () => {
  return (
    <>
      {/* Hero Section */}
      <section id="home" className="relative overflow-hidden py-20 sm:py-10 px-2 text-center bg-gradient-to-br from-blue-700 to-indigo-800 text-white shadow-2xl rounded-b-[5rem] sm:rounded-b-[8rem] flex flex-col items-center justify-center">
      ...
      <section id="how-it-works" className="py-24 px-4 max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {/* Step 1 */}
          <div className="shadow-xl hover:shadow-2xl transition-shadow duration-300 rounded-2xl border-2 border-blue-200 bg-white transform hover:-translate-y-2">
            <div className="flex flex-col items-center space-y-4 p-8">
              <div className="flex items-center justify-center w-16 h-16 bg-blue-600 text-white rounded-full text-3xl font-bold border-4 border-blue-300">1</div>
              <h4 className="text-2xl font-semibold text-blue-800 text-center">Sign Up & Connect</h4>
            </div>
            <div className="p-6 pt-0">
              <p className="text-gray-700 text-lg text-center">Securely link your employer's payroll and verify your details in minutes.</p>
            </div>
          </div>
          {/* Step 2 */}
          <div className="shadow-xl hover:shadow-2xl transition-shadow duration-300 rounded-2xl border-2 border-blue-200 bg-white transform hover:-translate-y-2">
            <div className="flex flex-col items-center space-y-4 p-8">
              <div className="flex items-center justify-center w-16 h-16 bg-blue-600 text-white rounded-full text-3xl font-bold border-4 border-blue-300">2</div>
              <h4 className="text-2xl font-semibold text-blue-800 text-center">Request Your Advance</h4>
            </div>
            <div className="p-6 pt-0">
              <p className="text-gray-700 text-lg text-center">See your earned wages available and request the amount you need.</p>
            </div>
          </div>
          {/* Step 3 */}
          <div className="shadow-xl hover:shadow-2xl transition-shadow duration-300 rounded-2xl border-2 border-blue-200 bg-white transform hover:-translate-y-2">
            <div className="flex flex-col items-center space-y-4 p-8">
              <div className="flex items-center justify-center w-16 h-16 bg-blue-600 text-white rounded-full text-3xl font-bold">3</div>
              <h4 className="text-2xl font-semibold text-blue-800 text-center">Get Instant Funds</h4>
            </div>
            <div className="p-6 pt-0">
              <p className="text-gray-700 text-lg text-center">Money is transferred directly to your bank account, often in seconds.</p>
            </div>
          </div>
          {/* Step 4 */}
          <div className="shadow-xl hover:shadow-2xl transition-shadow duration-300 rounded-2xl border-2 border-blue-200 bg-white transform hover:-translate-y-2">
            <div className="flex flex-col items-center space-y-4 p-8">
              <div className="flex items-center justify-center w-16 h-16 bg-blue-600 text-white rounded-full text-3xl font-bold border-4 border-blue-300">4</div>
              <h4 className="text-2xl font-semibold text-blue-800 text-center">Automatic Repayment</h4>
            </div>
            <div className="p-6 pt-0">
              <p className="text-gray-700 text-lg text-center">The advance is automatically deducted from your next paycheck – no manual effort.</p>
            </div>
          </div>
        </div>
      </section>
