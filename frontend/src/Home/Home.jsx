...
const how_it_work = [
  [
    1,
    "Sign Up & Connect",
    "Securely link your employer's payroll and verify your details in minutes.",
  ],
  [
    2,
    "Request Your Advance",
    "See your earned wages available and request the amount you need.",
  ],
  [
    3,
    "Get Instant Funds",
    "Money is transferred directly to your bank account, often in seconds.",
  ],
  [
    4,
    "Automatic Repayment",
    "The advance is automatically deducted from your next paycheck – no manual effort.",
  ],
];
...
const CustomAccordionItem = ({
  ...
  return (
    <div className="bg-white rounded-2xl shadow-xl border border-gray-200 px-6 transition-all duration-300 hover:shadow-2xl">
      ...
      >
        <div className="text-gray-700 text-lg pb-5">{children}</div>
      </div>
    </div>
  );
};
...
const Home = () => {
  return (
    <>
      ...
      <section
        id="home"
        className="relative overflow-hidden py-20 sm:py-0 px-2 text-center bg-gradient-to-br from-blue-700 to-indigo-800 text-white shadow-2xl rounded-b-[5rem] sm:rounded-b-[8rem] flex flex-col items-center justify-center"
      >
        ...
        <div className="absolute inset-0 z-0 opacity-20">
          ...
          >
            ...
            <ellipse
              ...
              fill="url(#grad1)"
              opacity="0.3"
              transform="rotate(20 250 500)"
            />
            <polygon
              points="500,100 600,250 400,250"
              fill="url(#grad1)"
              opacity="0.2"
              transform="rotate(10 500 175)"
            />
          </svg>
        </div>
        <div className="relative z-10 max-w-5xl mx-auto">
          <section className="text-center py-20 px-4 bg-gradient-to-r">
            <h2 className="text-4xl md:text-5xl font-bold mb-4 text-white ">
              Get Paid Before Payday – Instantly
            </h2>
            <p className="text-lg md:text-xl mb-8 text-cyan-300">
              Fast, employer-approved salary advances with zero hassle.
            </p>
            <button
              size="lg"
      ...
      <section id="how-it-works" className="py-24 px-4 max-w-7xl mx-auto">
        <h3 className="text-4xl sm:text-5xl font-bold text-center mb-16 text-blue-700">
          How FinWise Works for You
        </h3>
              ...
              <SwiperSlide key={idx}>
                <div className="shadow-xl hover:shadow-2xl transition-shadow duration-300 rounded-2xl border-2 border-blue-200 bg-white transform hover:-translate-y-2 h-full flex flex-col">
                  <div className="flex flex-col items-center space-y-4 p-8">
                    <div className="flex items-center justify-center w-16 h-16 bg-blue-600 text-white rounded-full text-3xl font-bold border-4 border-blue-300">
                      {idx}
                    </div>
                    <h4 className="text-2xl font-semibold text-blue-800 text-center">
                      {title}
                    </h4>
                  </div>
                  <div className="p-6 pt-0 flex-grow">
                    {" "}
                    {/* flex-grow to make sure content pushes to bottom if needed */}
        ...
        <div className="hidden md:grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          {how_it_work.map(([idx, title, desc]) => (
            <div
              key={idx}
              className="shadow-xl hover:shadow-2xl transition-shadow duration-300 rounded-2xl border-2 border-blue-200 bg-white transform hover:-translate-y-2"
            >
              <div className="flex flex-col items-center space-y-4 p-8">
                <div className="flex items-center justify-center w-16 h-16 bg-blue-600 text-white rounded-full text-3xl font-bold border-4 border-blue-300">
                  {idx}
      ...
      <section
        id="why-choose"
        className="bg-gradient-to-br from-blue-100 to-indigo-100 py-24 px-4 rounded-t-[5rem] sm:rounded-t-[8rem] shadow-inner flex flex-col items-center"
      >
        <h3 className="text-4xl sm:text-5xl font-bold text-center mb-16 text-blue-700">
          Why FinWise is Your Smart Choice
        </h3>
        ...
        <div className="relative md:hidden w-full">
          ...
          >
            {features.map((feature, idx) => (
              <SwiperSlide key={idx}>
                <div className="bg-white border-2 border-blue-200 rounded-2xl p-6 shadow-xl h-full flex flex-col items-center text-center hover:shadow-2xl transition duration-300 transform hover:-translate-y-2">
                  {feature.icon}
        ...
        {/* Desktop: Grid */}
        <div className="hidden md:grid md:grid-cols-2 lg:grid-cols-3 gap-8 w-full max-w-7xl">
          {features.map((feature, idx) => (
            <div
              key={idx}
              className="bg-white border-2 border-blue-200 rounded-2xl p-6 shadow-xl flex flex-col items-center text-center hover:shadow-2xl transition duration-300 transform hover:-translate-y-2"
            >
              {feature.icon}
              <h4 className="text-xl font-semibold text-blue-800 mb-2">
                {feature.title}
      ...
      <section className="bg-gradient-to-br from-blue-700 to-indigo-800 text-white py-20 text-center shadow-2xl rounded-t-[5rem] sm:rounded-t-[8rem] flex flex-col items-center justify-center">
        <h4 className="text-3xl font-bold mb-4">
          Ready to get your salary in advance?
        </h4>
